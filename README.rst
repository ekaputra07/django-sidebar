...
**3. Create a directory called *sidebar\_widgets* inside the project directory :**

It is in the same directory as *manage.py* file, and **remember** to put an empty **\_\_init\_\_.py** in it so python can access its content.
